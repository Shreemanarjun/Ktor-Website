! function(t, e) {
    if ("function" == typeof define && define.amd) define(["moment", "jquery"], function(a, i) {
        return i.fn || (i.fn = {}), t.daterangepicker = e(a, i)
    });
    ...
    var a = function(a, i, s) {
        ...
        if ("object" == typeof i.ranges) {
            for (l in i.ranges) {
                ...
                var m = this.maxDate;
                if (this.dateLimit && m && o.clone().add(this.dateLimit).isAfter(m) && (m = o.clone().add(this.dateLimit)), m && h.isAfter(m) && (h = m.clone()), !(this.minDate && h.isBefore(this.minDate, this.timepicker ? "minute" : "day") || m && o.isAfter(m, this.timepicker ? "minute" : "day"))) {
                    var f;
